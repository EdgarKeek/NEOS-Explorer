...
module.exports = {
  ...
  get_masternodecount: function(cb) {
    if  (settings.masternodes.cli != "masternode") {
      var uri = base_url + settings.masternodes.cli + '?command=count';
    } else {
  ...
  get_masternodeonlinecount: function(cb) {
    if  (settings.masternodes.cli != "masternode") {
      var uri = base_url + settings.masternodes.cli + '?command=count&filter=enabled';
    } else {
      var uri = base_url + 'getmasternodecount';
    }
    request({uri: uri, json: true}, function (error, response, body) {
  ...
  get_masternodelist: function(cb) {
    if  (settings.masternodes.cli != "masternode") {
      var uri = base_url + settings.masternodes.cli + 'list?mode=full';
    } else {
